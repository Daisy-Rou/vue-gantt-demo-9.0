...
dhtmlxGantt v.9.0.13 Professional Evaluation
...
function Qe(t) {
  ...
  t._isLinksCacheEnabled = function() {
    ...
    var y = this._getImplicitLinks(s, h, function(S) {
    ...
    if (this.isSummaryTask(l) && !o(l)) {
      ...
      for (var f in this.eachTask(function(k) {
        this.isSummaryTask(k) && !o(k) || (_[k.id] = k);
      }, l.id), _) {
        var y = _[f];
        if (t._isAutoSchedulable(y)) {
          var v = u ? y.$source : y.$target;
          h = !1;
          ...
          if (!h) {
            let k = !0;
            for (const x in t._linkedTasks[y.id]) if (t.isChildOf(x, s.target)) {
              k = !1;
              break;
            }
            let w = 0;
            k && (w = d(y)), c.push({ task: y.id, taskParent: y.parent, lag: w, subtaskLink: !0 });
          }
        }
      }
...
class je {
  ...
  resolveRelationDate(n, e, i) {
    ...
    for (let _ = 0; _ < d.length; _++) {
      ...
      this._comparator.isGreaterOrDefault(u, y, l) && (u = y), this._comparator.isGreaterOrDefault(s, v, l) && this._comparator.isGreaterOrDefault(a, y, l) && (a = y, o = v, r = f.id);
    }
...
class Fe {
  ...
  resolveRelationDate(n, e, i) {
    ...
    for (let f = 0; f < l.length; f++) {
      const y = l[f];
      o = y.preferredStart;
      const v = this.getEarliestStartDate(y, i, s);
      if (this._comparator.isSmallerOrDefault(u, v, s) && (u = v), this._comparator.isSmallerOrDefault(o, v, s) && this._comparator.isSmallerOrDefault(a, v, s) && (a = v, r = y.id), !s.duration) {
    ...
    if (a) if (s.duration) a = this._gantt.getClosestWorkTime({ date: a, dir: "future", task: s }), c = this._gantt.calculateEndDate({ start_date: a, duration: s.duration, task: s });
      ...
      if (d[y.finish_to_finish] !== void 0) {
        const v = l.length === 1;
        let b = !0;
        for (const g in d) if (g != y.finish_to_finish && d[y.finish_to_finish] < d[g]) {
          b = !1;
          break;
        }
        (v || b) && (f = "past");
...
function dt(t, n) {
  var o;
  const e = document.documentElement, i = K(n), { clientX: a, clientY: r } = ((o = t.touches) == null ? void 0 : o[0]) ?? t;
...
const Nn = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: xt, closest: ct, getActiveElement: De, getChildNodes: An, getClassName: it, getClosestSizedElement: In, getFocusableNodes: Ut, getNodePosition: K, getRelativeEventPosition: dt, getRelativeNodePosition: Mn, getRootNode: Dt, getScrollSize: En, getTargetNode: At, hasClass: function(t, n) {
...
let _i = class {
  ...
  attach(t, n, e) {
    ...
    const u = () => {
      ...
      o = null;
      let y = u();
      y && i.utils.dom.closest(f.target, y) || (r.registerProvider("clickDrag", () => ({ autoscroll: this._mouseDown })), n && f[n] !== !0 || (o = this._getCoordinates(f, t)));
    }, h = (f) => {
...
class pi {
  ...
  _show_quick_info(n, e) {
    ...
    if (i.config.quick_info_detached) {
      ...
      const f = Math.min(Math.max(l.x, n.left - n.dx * (o - n.width)), c), y = _;
...
class vi {
  ...
  _calculateTooltipPosition(n) {
    const e = this._gantt, i = this._getViewPortSize(), a = this.getNode(), r = { top: 0, left: 0, width: a.offsetWidth, height: a.offsetHeight, bottom: 0, right: 0 }, o = e.config.tooltip_offset_x, s = e.config.tooltip_offset_y, l = document.body, d = dt(n, l), u = K(l);
...
class ki {
  ...
  attach(n) {
    ...
    let a = null;
    const r = (o) => {
      const s = At(o), l = ct(s, n.selector);
...
const $i = { auto_scheduling: function(t) {
  ...
  var n = function(i) {
    var a = an(i), r = nn(), o = { _freeSlack: {}, _totalSlack: {}, _slackNeedCalculate: !0, _linkedTasksById: {}, _successorsByTaskId: {}, _projectEnd: null, _calculateSlacks: function() {
      ...
      s.forEach((f) => {
        ...
        if (!y) return;
        _[f.source] = !0;
        let v = u.getDist(y, i.getTask(f.target));
      ...
      for (var c = {}, h = i.getTaskByTime(), _ = 0; _ < l.length; _++) {
        ...
        if (this._isCompletedTask(y)) c[y.id] = 0;
          ...
          for (var f = 0; f < v.length; f++) {
            ...
            let p = 0;
            c[m.id] !== void 0 && (p += c[m.id]), p += u.getDist(y, m), p -= g.link.lag || 0, b = b === null ? p : Math.min(b, p);
          }
          c[y.id] = b || 0;
      ...
      i.attachEvent("onAfterLinkAdd", s), i.attachEvent("onTaskIdChange", s), i.attachEvent("onAfterLinkUpdate", s), i.attachEvent("onAfterLinkDelete", s), i.attachEvent("onAfterTaskAdd", s), i.attachEvent("onAfterTaskUpdate", s), i.attachEvent("onAfterTaskDelete", s), i.attachEvent("onRowDragEnd", s), i.attachEvent("onAfterTaskMove", s), i.attachEvent("onParse", s), i.attachEvent("onClear", s), i.$data.tasksStore.attachEvent("onClearAll", s), i.$data.linksStore.attachEvent("onClearAll", s);
    } };
    return o;
  }(t);
  ...
  var e = function(i) {
    return i._isProjectEnd = function(a) {
      ...
      i.attachEvent("onAfterLinkAdd", r), i.attachEvent("onAfterLinkUpdate", r), i.attachEvent("onAfterLinkDelete", r), i.attachEvent("onAfterTaskAdd", r), i.attachEvent("onTaskIdChange", o), i.attachEvent("onAfterTaskUpdate", r), i.attachEvent("onAfterTaskDelete", r), i.attachEvent("onParse", r), i.attachEvent("onClear", r), i.$data.tasksStore.attachEvent("onClearAll", r), i.$data.linksStore.attachEvent("onClearAll", r);
      var s = function() {
  ...
  function l(u, c, h) {
    ...
    for (let f = 0; f < u.length; f++) {
      const y = u[f];
      for (let v = 0; v < y.commands.length; v++) y.commands[v].entity === _.command.entity.task ? r(y.commands[v], c, h) : y.commands[v].entity === _.command.entity.link && s(y.commands[v], c, h);
    }
  }
  function d(u, c, h) {
    const _ = n;
  ...
  function n(s, l, d) {
    ...
    for (let c = 0; c < s.length; c++) {
      ...
      }).reduce(function(f, y, v) {
        return y === h && f.push(v), f;
      }, []);
  ...
  t._groups = { relation_property: null, relation_id_property: "$group_id", group_id: null, group_text: null, loading: !1, loaded: 0, dynamicGroups: !1, set_relation_value: void 0, _searchCache: null, init: function(s) {
    ...
    this._searchCache = null, s.attachEvent("onBeforeTaskMove", function(c, h, _) {
      var f = h === this.config.root_id, y = this._groups.dynamicGroups && !(this._groups.set_relation_value instanceof Function);
      if (l.is_active() && (f || y)) return !1;
      var v = s.getTask(c);
      ...
      if (s.config.order_branch && s.config.order_branch != "marker") {
        ...
        if (_.$initial_parent) {
          if (_.parent == s.config.root_id) {
            var f = s.getTask(_.$rendered_parent), y = s.getTask(_.$initial_parent), v = !1;
            this._groups.dynamicGroups && f[this._groups.group_id] != y[this._groups.group_id] && (v = !0), this._groups.dynamicGroups || f[this._groups.group_id] == y[this._groups.relation_property] || (v = !0), v && (_.parent = _.$initial_parent);
          }
    ...
    s.$data.tasksStore.setParent = function(c, h) {
      ...
      if (l.set_relation_value instanceof Function && s.isTaskExists(h)) {
        ...
        if (!v.$virtual) {
          ...
          var y = l._searchCache[f];
          _ = s.getTask(y)[l.relation_id_property];
        }
    ...
    s.eachTask(function(y) {
      s.isSelectedTask(y.id) && _.push(y.id);
    }), s._clear_data();
    var f = s.config.auto_scheduling_initial;
    s.config.auto_scheduling_initial = !1, s.parse(h), _.forEach(function(y) {
      s.isTaskExists(y) && s.selectTask(y);
    ...
    this._groups.regroup = function() {
      var f = t.getTaskByTime(), y = {}, v = !1;
      f.forEach(function(g) {
        g.$virtual && g.$open !== void 0 && (y[g[h]] = g.$open, v = !0);
      });
      var b = function(g, m, p) {
        var k;
        return k = g.groups ? p._groups.dynamicGroups ? function(w, x) {
...
var Ue = function(t) {
  ...
  ot.apply(this, [t]), this._branches = {}, this.pull = {}, this.$initItem = function(s) {
    ...
    return d && !gt(d.parent, l.parent) && this.move(l.id, l.$index || -1, l.parent || this._ganttConfig.root_id), l;
...
${s}`), a = o.subscales || [];
    ...
    for (var u = this.splitSize(o, i.length), c = r, h = [], _ = i.length - 1; _ >= 0; _--) {
      var f = _ == i.length - 1, y = this.initScaleConfig(i[_], s, l);
      f && this.processIgnores(y), this.initColSizes(y, a, c, u[_]), this.limitVisibleRange(y), f && (c = y.full_width), h.unshift(y);
    }
...
function Mi(t) {
  var n = function(u) {
    ...
    if (u.config.scale_offset_minimal) {
      var f = new Fn(u), y = [f.primaryScale()].concat(f.getSubScales());
...
let ee = se, Wn = class {
  ...
  afterUpdate(t, n, e) {
    ...
    for (let c = 0; c < u.length; c++) {
      const h = u[c], _ = h.getAttribute("type"), f = h.getAttribute("sid"), y = h.getAttribute("tid");
  ...
  _sendData(t, n) {
    ...
    if (this._tMode === "CUSTOM") {
      ...
      const u = this.getGanttMode(), c = (_) => {
        ...
        _ && (f = _.action || l, y = _.sid || y, v = _.id || _.tid || v), this.afterUpdateCallback(y, v, f, _, u);
      };
      let h;
...
function zi(t) {
  ...
  function c(p, k) {
    ...
    if (p.mode = p.mode || u, p.mode === d && (isNaN(Number(p.duration)) && (k = k || t.getTask(p.task_id), p.duration = t.calculateDuration({ start_date: p.start_date, end_date: p.end_date, id: k })), x && (k = k || t.getTask(p.task_id), p.delay = t.calculateDuration({ start_date: k.start_date, end_date: p.start_date, id: k }))), p.mode !== l && (k || t.isTaskExists(p.task_id))) {
  ...
  function _(p, k) {
    ...
    return p.mode === d ? (w = t.calculateEndDate({ start_date: $, duration: p.duration, task: k }), x = p.duration) : (w = new Date(k.end_date), x = k.duration - p.delay), { start_date: $, end_date: w, duration: x };
  }
  function f(p) {
  ...
  function v(p, k) {
    ...
    }), s == o ? p[t.config.resource_property] = k : s == r && (p[t.config.resource_property] = k.map(function(w) {
...
const Ge = function(t, n) {
  ...
  if (s.splitChild && (h = Math.floor((l - d) / 2)), r || o) {
    let _ = Math.min(e.height, l) - d, f = 2, y = o && a.bar_height >= a.row_height, v = s.splitChild && e.height >= l;
...
class qi {
  ...
  findColumnsIndexes() {
    ...
    let l, d = 0, u = e.length - 1, c = (f, y) => f <= y, h = (f) => ++f;
    this.$gantt.config.rtl && (d = e.length - 1, u = 0, c = (f, y) => f >= y, h = (f) => --f);
...
ue.prototype = { init: function(t) {
  ...
  var l = function(u, c) {
    var h = { column_before_start: u.bind(function(_, f, y) {
      var v = c.$getConfig(), b = tt(y, v.grid_resizer_column_attribute);
      if (!b || !ct(b, ".gantt_grid_column_resize_wrap")) return !1;
      var g = this.locate(y, v.grid_resizer_column_attribute), m = c.getGridColumns()[g];
      return c.callEvent("onColumnResizeStart", [g, m]) !== !1 && void 0;
    }, u), column_after_start: u.bind(function(_, f, y) {
      var v = c.$getConfig(), b = this.locate(y, v.grid_resizer_column_attribute);
    ...
    }, u), column_drag_move: u.bind(function(_, f, y) {
      var v = c.$getConfig(), b = _.config, g = c.getGridColumns(), m = parseInt(b.drag_index, 10), p = g[m], k = K(c.$grid_scale), w = parseInt(b.marker.style.left, 10), x = p.min_width ? p.min_width : v.min_grid_column_width, $ = c.$grid_data.offsetWidth, S = 0, T = 0;
      ...
      return b.left = w - 1, T = Math.abs(w - S), p.max_width && T > p.max_width && (T = p.max_width), v.rtl && (S = k.width - S + 2 - T), b.marker.style.top = k.y + "px", b.marker.style.left = k.x - 1 + S + "px", b.marker.style.width = T + "px", c.callEvent("onColumnResize", [m, g[m], T - 1]), !0;
    }, u), column_drag_end: u.bind(function(_, f, y) {
      for (var v = c.$getConfig(), b = c.getGridColumns(), g = 0, m = parseInt(_.config.drag_index, 10), p = b[m], k = 0; k < m; k++) g += b[k].width;
    ...
    return { init: function() {
      var _ = u.$services.getService("dnd"), f = c.$getConfig(), y = new _(c.$grid_scale, { updates_per_second: 60 });
      u.defined(f.dnd_sensitivity) && (y.config.sensitivity = f.dnd_sensitivity), y.attachEvent("onBeforeDragStart", function(v, b) {
      ...
      for (var _ = c.getGridColumns(), f = c.$getConfig(), y = 0, v = c.$config.width, b = f.scale_height, g = 0; g < _.length; g++) {
        var m, p = _[g];
        if (y += p.width, m = f.rtl ? v - y : y, p.resize && g != _.length - 1) {
          var k = document.createElement("div");
          k.className = "gantt_grid_column_resize_wrap", k.style.top = "0px", k.style.height = b + "px", k.innerHTML = "<div class='gantt_grid_column_resize'></div>", k.setAttribute(f.grid_resizer_column_attribute, g), k.setAttribute("column_index", g), u._waiAria.gridSeparatorAttr(k), c.$grid_scale.appendChild(k), k.style.left = Math.max(0, m) + "px";
        }
      }
    } };
  }(n, this);
  ...
  var d = function(u, c) {
    var h = { row_before_start: u.bind(function(_, f, y) {
    ...
    }, u), row_after_start: u.bind(function(_, f, y) {
      var v = c.$getConfig(), b = this.locate(y, v.task_grid_row_resizer_attribute);
    ...
    }, u), row_drag_move: u.bind(function(_, f, y) {
      var v = c.$config.rowStore, b = c.$getConfig(), g = _.config, m = g.drag_id, p = c.getItemHeight(m), k = c.getItemTop(m) - f.scrollTop, w = K(c.$grid_data), x = parseInt(g.marker.style.top, 10), $ = k + w.y, S = 0, T = b.min_task_grid_row_height;
    ...
    }, u), row_drag_end: u.bind(function(_, f, y) {
      var v = c.$config.rowStore, b = _.config, g = b.drag_id, m = v.getItem(g), p = c.getItemHeight(g), k = b.marker_height;
      c.callEvent("onBeforeRowResizeEnd", [g, m, k]) !== !1 && m.row_height != k && (m.row_height = k, v.updateItem(g), c.callEvent("onAfterRowResize", [g, m, p, k]), this.render());
    }, u) };
    return { init: function() {
      var _ = u.$services.getService("dnd"), f = c.$getConfig(), y = new _(c.$grid_data, { updates_per_second: 60 });
      u.defined(f.dnd_sensitivity) && (y.config.sensitivity = f.dnd_sensitivity), y.attachEvent("onBeforeDragStart", function(v, b) {
  ...
  for (var u = 0; u < a.length; u++) {
    ...
    var y = t._sort && h.name == t._sort.name ? `<div data-column-id="${h.name}" class="gantt_sort gantt_${t._sort.direction}"></div>` : "", v = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, c ? "gantt_last_cell" : "", i.grid_header_class(h.name, h)].join(" "), b = "width:" + (_ - (c ? 1 : 0)) + "px;", g = h.label || s["column_" + h.name] || s[h.name];
    typeof g == "function" && (g = g.call(t, h.name, h)), g = g || "";
    let p = !1;
    t.config.external_render && t.config.external_render.isElement(g) && (p = !0, d[h.name] = g);
    var m = "<div class='" + v + "' style='" + b + "' " + t._waiAria.gridScaleCellAttrString(h, g) + " data-column-id='" + h.name + "' column_id='" + h.name + "' data-column-name='" + h.name + "' data-column-index='" + u + "'>" + (p ? "<div data-component-container></div>" : g) + y + "</div>";
    r.push(m);
  }
  ...
  const s = (d, u) => {
    for (let c in d.dates) {
      ...
      for (const _ in u.dates) {
        const f = u.dates[_];
        if (_ == c && (o.dates[c] = !(!h || !f)), Array.isArray(h)) {
          const y = Array.isArray(f) ? f : u.hours;
          o.dates[c] = this._toHoursArray(this._mergeHoursConfig(h, y));
        }
      }
    }
  };
...
Pe.prototype = { units: ["year", "month", "week", "day", "hour", "minute"], _clearCaches: function() {
  ...
  for (var _ = !1; r.valueOf() < o.valueOf(); ) {
    if (_ = (u = this._nextDate(r, e, i)).valueOf() > o.valueOf(), this._isWorkTime(r, e)) (c || h && _) && (s = a[e + "_start"](new Date(r)), l = a.add(s, i, e)), c ? (c = !1, u = this._nextDate(s, e, i), d += (l.valueOf() - r.valueOf()) / (l.valueOf() - s.valueOf())) : h && _ ? (h = !1, d += (o.valueOf() - r.valueOf()) / (l.valueOf() - s.valueOf())) : d++;
      ...
      y && !this._isWorkTime(r, y) && (u = this._getClosestWorkTimeFuture(r, y));
    }
    r = u;
  }
  return d;
  ...
  for (var o = 0, s = [], l = 0, d = this._isMinutePrecision(i); a < n; ) {
    ...
    if (s.length && l) if (s[0].start >= h && c >= l) {
      ...
      for (var _ = !1, f = null, y = 0; y < s.length; y++) if (s[y].start <= h && s[y].end > h) {
        _ = !0, f = s[y];
        break;
      }
  ...
  t._init_task_timing = function(o) {
    ...
    if (o) {
      ...
      if (l || d.start_date && d.end_date && (c.$no_start || c.$no_end)) {
        ...
        t.resetProjectDates(d), l || _ != d[y].valueOf() || f != d[v].valueOf() || (h = !1), h && !s && this.refreshTask(d.id, !0), c.scheduled_summary && (h = !0);
      }
...
const ia = (t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1752561904000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1752561904000 > 5184e6 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
      ...
      if (this.config.preserve_scroll = !1, this.$layout.resize(), this.config.preserve_scroll = l, this.config.preserve_scroll && o) {
        ...
        this.$layout.getScrollbarsInfo().forEach((c) => {
          ...
          c.boundViews.forEach((f) => {
            ...
            c.y && c.y != o.y && y && !_ && y.scrollTo(void 0, 0), c.x_pos && c.x_pos != o.x && y && _ && y.scrollTo(c.x_pos, void 0);
          });
        });
      }
    }
...
`);
    if (typeof 1752561904000 > "u") return;
    const e = function() {
      var i, a;
      setTimeout(() => {
        Date.now() - 1752561904000 > 7776e6 && window.alert(n), e();
...
function Ba() {
  this.constants = xi, this.version = "9.0.13", this.license = "evaluation", this.templates = {}, this.ext = {}, this.keys = { edit_save: this.constants.KEY_CODES.ENTER, edit_cancel: this.constants.KEY_CODES.ESC };
}
function za(t) {
  ...
  n.plugins = function(l) {
    ...
    return { cache: !0, method: "get", parse: function(d) {
      return typeof d != "string" ? d : (d = d.replace(/^[\s]+/, ""), typeof DOMParser > "u" || bt.isIE ? Y.ActiveXObject !== void 0 && ((u = new Y.ActiveXObject("Microsoft.XMLDOM")).async = "false", u.loadXML(d)) : u = new DOMParser().parseFromString(d, "text/xml"), u);
      var u;
      ...
      return new l.Promise(function(y, v) {
        ...
        h && (b.onreadystatechange = function() {
          if (b.readyState == 4 || g && b.readyState == 3) {
            ...
            setTimeout(function() {
              typeof _ == "function" && _.apply(Y, [{ xmlDoc: b, filePath: u }]), y(b), typeof _ == "function" && (_ = null, b = null);
            }, 0);
          }
        });
  ...
  var a = function(l) {
    ...
    function u(c, h) {
      ...
      for (var f = { passive: !1 }, y = 0; y < _.length; y++) B(function(v) {
        l.event(c, v.down, B(function(g) {
          v.accessor(g) && (g.button !== void 0 && g.button !== 0 || (h.preventDefault && h.selector && ct(g.target, h.selector) && g.preventDefault(), l.config.touch && g.timeStamp && g.timeStamp - 0 < 300 || (this._settings.original_target = d(g), this._settings.original_element_sizes = { ...dt(g, In(c)), width: g.target.offsetWidth, height: g.target.offsetHeight }, l.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(B(function() {
    ...
    return u.prototype = { traceDragEvents: function(c, h) {
      ...
      }, this), y = Dt(l.$root), v = this.config.mousemoveContainer || Dt(l.$root), b = { passive: !1 }, g = B(function(m) {
        return l.eventRemove(v, h.move, f), l.eventRemove(y, h.up, g, b), this.dragEnd(c);
      }, this);
      ...
      if (l.config.touch) {
        var _ = h(c), f = _.target || _.srcElement, y = f.cloneNode(!0);
      ...
      if (c.push({ move: "mousemove", down: "mousedown", up: "mouseup", accessor: function(_) {
        ...
        } }) : Y.navigator.pointerEnabled ? c.push({ move: "pointermove", down: "pointerdown", up: "pointerup", accessor: function(_) {
          return _.pointerType == "mouse" ? null : _;
        } }) : Y.navigator.msPointerEnabled && c.push({ move: "MSPointerMove", down: "MSPointerDown", up: "MSPointerUp", accessor: function(_) {
  ...
  var r = /* @__PURE__ */ function(l) {
    ...
    function u(c, h, _) {
      ...
      l.config[c] && d[_] != f[c] && (h && y[_] || (y[_] = l.date.date_to_str(f[c]), d[_] = f[c]));
    }
    return { initTemplates: function() {
      var c = l.date, h = c.date_to_str, _ = l.config, f = h(_.xml_date || _.date_format, _.server_utc), y = c.str_to_date(_.xml_date || _.date_format, _.server_utc);
      u("date_scale", !0, void 0, l.config, l.templates), u("date_grid", !0, "grid_date_format", l.config, l.templates), u("task_date", !0, void 0, l.config, l.templates), l.mixin(l.templates, { xml_format: void 0, format_date: f, xml_date: void 0, parse_date: y, progress_text: function(v, b, g) {
        return "";
  ...
  o.registerProvider("global", function() {
    ...
    l.attachEvent("onDestroy", function() {
      ...
      if (!c._skipTaskRecalculation) for (var m = c.getVisibleItems(), p = 0; p < m.length; p++) {
        var k = m[p];
        k.$index = p, k.$local_index = l.getTaskIndex(k.id), l.resetProjectDates(k);
      }
    }), c.attachEvent("onFilterItem", function(m, p) {
      ...
      return !0;
    }), c.attachEvent("onIdChange", function(m, p) {
      l._update_flags(m, p);
      var k = l.getTask(p);
      c.isSilent() || (k.$split_subtask || k.rollup) && l.eachParent(function(w) {
        l.refreshTask(w.id);
      }, p);
    ...
    }), c.attachEvent("onBeforeItemMove", function(m, p, k) {
      return !Gt(m, l, c) || (console.log("The placeholder task cannot be moved to another position."), !1);
    }), c.attachEvent("onAfterItemMove", function(m, p, k) {
      var w = l.getTask(m);
    ...
    }), c.attachEvent("onStoreUpdated", function(m, p, k) {
    ...
    }), u = {}, l.attachEvent("onBeforeTaskDelete", function(m, p) {
      return u[m] = Me.getSubtreeLinks(l, m), !0;
    }), l.attachEvent("onAfterTaskDelete", function(m, p) {
      u[m] && l.$data.linksStore.silent(function() {
        for (var k in u[m]) l.isLinkExists(k) && l.$data.linksStore.removeItem(k), v(u[m][k]);
        u[m] = null;
      });
...
function ja(t) {
  ...
  function d(g, m, p) {
    ...
    g.hidden || o(!0), document.body.appendChild(k);
...
var Va = /* @__PURE__ */ function(t) {
  return function(n) {
    ...
    function a(h) {
      h = h || window.event;
      var _ = n.locate(h), f = o(h, e.click), y = !0;
    ...
    function l(h) {
      h = h || window.event;
      var _ = n.locate(h), f = o(h, e.doubleclick), y = !n.checkEvent("onTaskDblClick") || _ === null || n.callEvent("onTaskDblClick", [_, h]);
      if (y) {
        if (!s(f, h, _)) return;
...
var Ga = function(t) {
    ...
    function o(s, l, d) {
      ...
      return d && d.setAttribute(e.config.layer_attribute, !0), a[s] = { render_item: function(v, b, g, m, p) {
        if (b = b || d, !y || y(v)) {
          ...
          var $ = null;
          !Wt(e) && (h || f) && x ? (f ? f(v, x, k, w, e) : vn(x, h(v, k, w, e))) && ($ = u.call(e, v, k, w, x)) : $ = u.call(e, v, k, w, x), this.append(v, $, b);
          var S = b.nodeType == 11;
          _ && !S && $ && _.call(e, v, $, k);
        ...
        if (g && g.$getConfig().smart_rendering && !Wt(e) && this.rendered && (h || f)) {
          ...
          for (var T = {}, E = (S = 0, v.length); S < E; S++) {
            ...
            $[C.id] = !1, D && D.parentNode ? (f ? f(C, k, g, m, e) : vn(k, h(C, g, m, e))) ? (c && c.call(e, C, D, g, m, k), this.restore(C, p)) : $[C.id] = !0 : (T[v[S].id] = !0, this.render_item(v[S], p, k, g, m));
          }
  ...
  return { createGroup: function(e, i, a, r) {
    var o = { tempCollection: [], renderers: {}, container: e, filters: [], getLayers: function() {
      ...
      for (let u = 0; u < d.length; u++) {
        if (s = d[u], !(this.container() || s && s.container && s.container.isConnected)) continue;
        let c = s.container, h = s.id, _ = s.topmost;
  ...
  function i(r, o, s) {
    o.$getConfig(), r.getVisibleItems().forEach(function(l) {
      var d = function(u, c, h, _) {
        ...
        var f = yn(_.getTask(u.source), c), y = yn(_.getTask(u.target), c);
        if (!f || !y) return null;
...
function Xn(t, n, e, i, a) {
  ...
  return _ > f && (y = f, f = _, _ = y), c += -100, h += 100, _ += -100, f += 100, !(n.x > h && n.x > f) && !(n.x_end < c && n.x_end < _);
}
function qa(t, n) {
  if (t.view) {
    var e = t.view;
...
var Zn = function(t) {
  ...
  return W(n, t), n.prototype.destructor = function() {
    ...
    if (e.length) for (var a = e[0].$parent._xLayout ? "width" : "height", r = e[0].$parent.getNextSibling(e[0].$id) ? 1 : -1, o = i.value, s = i.isGravity, l = 0; l < e.length; l++) {
      ...
      !y || e[l].$content !== y || y.$config.scrollable || s || (this.$gantt.config.grid_width = o);
    }
  ...
  return W(e, t), e.prototype.init = function(a) {
    ...
    for (var a, r = 0, o = 0, s = this._isHorizontal(), l = this._getLinkedViews(), d = s ? "scrollWidth" : "scrollHeight", u = s ? "contentX" : "contentY", c = s ? "x" : "y", h = this._getScrollOffset(), _ = 0; _ < l.length; _++) if ((a = l[_]) && a.$content && a.$content.getSize && !a.$config.hidden) {
      ...
      if (f = y.hasOwnProperty(d) ? y[d] : y[u], h) y[u] > y[c] && y[u] > r && f > y[c] - h + 2 && (r = f + (s ? 0 : 2), o = y[c]);
      else {
        var v = Math.max(y[u] - f, 0);
        (f += v) > Math.max(y[c] - v, 0) && f > r && (r = f, o = y[c]);
      }
    }
    ...
    if (this._checkWheelTarget(r)) {
      ...
      var _ = d ? u * h * s.x : 2 * u * s.x, f = d ? c * h * s.y : c * s.y, y = this.$gantt.config.horizontal_scroll_key;
  ...
  function l(c, h, _) {
    var f = Math.floor(500 / c) || 1, y = Math.floor(500 / h) || 1, v = document.createElement("canvas");
    v.height = h * y, v.width = c * f;
    var b = v.getContext("2d");
    return function(m, p, k, w, x, $) {
      var S = x.createImageData(p * w, m * k);
      S.imageSmoothingEnabled = !1;
      for (var T = 1 * $.rightBorderWidth, E = a($.rightBorderColor), C = 0, D = 0, M = 0, I = 1; I <= w; I++) for (C = I * p - 1, M = 0; M < T; M++) for (D = 0; D < m * k; D++) g(C - M, D, E, S);
      var A = 1 * $.bottomBorderWidth, L = a($.bottomBorderColor);
      D = 0;
      for (var P = 1; P <= k; P++) for (D = P * m - 1, M = 0; M < A; M++) for (C = 0; C < p * w; C++) g(C, D - M, L, S);
      x.putImageData(S, 0, 0);
    }(h, c, y, f, b, _), v.toDataURL();
    function g(m, p, k, w) {
      var x = 4 * (p * (c * f) + m);
  ...
  return { render: function(c, h, _, f, y) {
      ...
      var v = function(p) {
        ...
        for (var A = 0; A < C.length; A++) {
          ...
          if (L != S && S !== void 0 || A == C.length - 1 || E > M) {
            for (var P = x, N = 0, z = Math.floor(M / k.row_height) * k.row_height, O = E; P > 0; ) {
              var H = Math.min(P, z);
    ...
    switch (h) {
      ...
      default:
        if (t.isVisible()) _ = !0;
          ...
          var y = o.modifiers, v = y.alt || y.ctrl || y.meta || y.shift;
          y.alt || v && r.getCommandHandler(o, "taskCell") || d && !t.isVisible() && (e.startEdit(l.id, l.columnName), _ = !0);
        }
    }
    return !_;
  });
...
function hr(t) {
  ...
  var i = { init: ur, createEditors: function(a) {
    ...
    var o = cr(t), s = [], l = [], d = null, u = { _itemId: null, _columnName: null, _editor: null, _editorType: null, _placeholder: null, locateCell: function(c) {
      ...
      var _ = { id: c, columnName: h }, f = a.getColumn(_.columnName), y = this.getEditorConfig(f.name);
      if (!y) return;
      ...
      var c = this.getState(), h = c.id, _ = c.columnName, f = a.getColumn(_), y = d.getItem(h), v = this.getEditorConfig(_);
      if (v) {
        var b = y[v.map_to];
      ...
      if (this.isVisible() && d.exists(this._itemId) && this.isChanged()) {
        ...
        if (d.exists(c)) {
          var _ = d.getItem(c), f = this.getEditorConfig(h), y = { id: c, columnName: h, newValue: this.getValue(), oldValue: this._getItemValue() };
          if (this.callEvent("onBeforeSave", [y]) !== !1 && (!this._editor.is_valid || this._editor.is_valid(y.newValue, y.id, a.getColumn(h), this._placeholder))) {
            ...
            v != "auto" ? (_[v] = b, o(_, v, t.config.inline_editors_date_processing), d.updateItem(c)) : this._editor.save(c, a.getColumn(h), this._placeholder), this.callEvent("onSave", [y]);
          }
          this.hide();
        }
      } else this.hide();
    }, _findEditableCell: function(c, h) {
      var _ = c, f = a.getGridColumns()[_], y = f ? f.name : null;
      if (y) {
...
function be(t) {
  function n(r, o, s) {
    ...
    if (y && v && r.bar_height !== "full" && r.bar_height < r.row_height) if (c === d.types.milestone) {
...
function gr(t) {
  function n(r, o, s) {
    ...
    const k = document.createElement("div"), w = o.getItemPosition(r, r.$auto_start_date || r.start_date, r.$auto_end_date || r.end_date);
    k.classList.add("gantt_task_line_actual", "gantt_task_line", "gantt_project"), k.style.cssText = ["position:absolute", "left:" + w.left + "px", "top:16px", "height:8px", "width:" + w.width + "px"].join(";"), b.appendChild(k), d.show_progress && c != d.types.milestone && function(T, E, C, D, M) {
      var I = 1 * T.progress || 0;
      C = Math.max(C - 2, 0);
      var A = document.createElement("div"), L = Math.round(C * I);
...
function mr(t) {
  var n = { current_pos: null, dirs: { left: "left", right: "right", up: "up", down: "down" }, path: [], clear: function() {
    ...
    if (y.from_start && y.to_start) this.point_to(h.left, f), v ? (this.point_to(h.down, u), this.point_to(h.right, c)) : (this.point_to(h.right, c), this.point_to(h.down, u)), this.point_to(h.right, f);
    else if (!y.from_start && y.to_start) if (u !== 0 && (v = l.e_x > l.x + 2 * f), this.point_to(h.right, f), v) c -= f, this.point_to(h.down, u), this.point_to(h.right, c);
    else {
      c -= 2 * f;
      var b = u > 0 ? 1 : -1;
      this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, c), this.point_to(h.down, b * (Math.abs(u) - _ / 2)), this.point_to(h.right, f);
    }
    else y.from_start || y.to_start ? y.from_start && !y.to_start && (u !== 0 && (v = l.e_x > l.x - 2 * f), this.point_to(h.left, f), v ? (c += 2 * f, b = u > 0 ? 1 : -1, this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, c), this.point_to(h.down, b * (Math.abs(u) - _ / 2)), this.point_to(h.left, f)) : (c += f, this.point_to(h.down, u), this.point_to(h.right, c))) : (this.point_to(h.right, f), v ? (this.point_to(h.right, c), this.point_to(h.down, u)) : (this.point_to(h.down, u), this.point_to(h.right, c)), this.point_to(h.left, f));
    return this.path;
  ...
  return { render: function(a, r, o) {
    ...
    return y && (f += " " + y), o.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(a) && (f += " gantt_critical_link"), _.className = f, r.$config.link_attribute && (_.setAttribute(r.$config.link_attribute, a.id), _.setAttribute("link_id", a.id)), a.color && _.style.setProperty("--dhx-gantt-link-background", a.color), t._waiAria.linkAttr(a, _), _;
...
function ti(t) {
  ...
  return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
    ...
    return s = n[o] ? n[o] : n[o] = function(l, d, u, c) {
      ...
      const y = u.unit, v = u.step, b = [];
      let g, m, p, k, w;
      const x = c.$getConfig();
      for (let $ = 0; $ < u.trace_x.length; $++) g = new Date(u.trace_x[$]), m = t.date.add(g, v, y), w = f[g.valueOf()] || {}, p = w.tasks || [], k = w.assignments || [], p.length || x.resource_render_empty_cells ? b.push({ start_date: g, end_date: m, tasks: p, assignments: k }) : b.push(null);
      return b;
    }(e, i, a, r), s;
  };
}
...
function br(t) {
  ...
  function s(l, d, u, c, h, _, f) {
    ...
    if (y || v) {
      ...
      return m.className = ["gantt_histogram_cell", y].join(" "), m.setAttribute(f.$config.item_attribute, l.id), m.style.cssText = ["left:" + d.left + "px", "width:" + d.width + "px", "height:" + g + "px", "line-height:" + g + "px", "top:" + (d.top + 1) + "px"].join(";"), v && (v = "<div class='gantt_histogram_label'>" + v + "</div>"), b && (v = "<div class='gantt_histogram_fill' style='height:" + 100 * Math.min(b / u || 0, 1) + "%;'></div>" + v), v && (m.innerHTML = v), m;
    }
    return null;
  }
  return { render: function(l, d, u, c) {
    var h = d.$getTemplates(), _ = d.getScale(), f = n(l, u.resource_property, _, d), y = [], v = {}, b = l.capacity || d.$config.capacity || 24;
    ...
    for (var g = !!c, m = Ct(_, c), p = m.start; p <= m.end; p++) {
      ...
      if (k && (!g || Vt(p, _, c, t))) {
        ...
        var x = d.getItemPosition(l, k.start_date, k.end_date), $ = s(l, x, b, 0, h, k, d);
        $ && (y.push($), e[l.id][p] = $);
      }
    }
    var S = null;
    ...
    var _ = u.$getTemplates(), f = u.getScale(), y = n(l, c.resource_property, f, u), v = l.capacity || u.$config.capacity || 24, b = {}, g = !!h, m = Ct(f, h), p = {};
...
const Tr = { init: function(t, n) {
  ...
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    ...
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(s, l) {
      ...
      var l = K(n.$grid_data), d = l.x + n.$grid.scrollLeft, u = s.pos.y - 10, c = n.getItemHeight(i.config.id);
      u < l.y && (u = l.y);
      ...
      var l = K(n.$grid_data), d = n.$state.scrollTop || 0, u = t.$grid_data.getBoundingClientRect().height + d, c = s.pageY - l.y + d;
...
const Sn = { removeLineHighlight: function(t) {
  ...
  var i = function(r, o) {
    var s = K(o.$grid_data), l = dt(r, o.$grid_data), d = s.x + o.$grid.scrollLeft, u = l.y - 10, c = o.getItemHeight(r.targetId);
    u < s.y && (u = s.y);
  ...
  function o(s) {
    var l, d = function(f) {
      var y = dt(f, n.$grid_data).y, v = n.$config.rowStore;
    ...
    }(s), u = null, c = n.$config.rowStore, h = !n.$getConfig().order_branch_free, _ = dt(s, n.$grid_data).y;
    return document.doctype || (_ += window.scrollY), d !== c.$getRootId() && (u = (_ - n.getItemTop(d)) / n.getItemHeight(d)), h ? (l = xn(i.config.id, d, u, _, c, i.config.level)) && l.targetParent && r(l.targetParent) && (d = c.getPrevSibling(l.targetParent), l = xn(i.config.id, d, u, _, c, i.config.level)) : l = function(f, y, v, b, g) {
      var m;
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        if (this.drag.start_drag) {
          var s = dt(o, a.$task_data), l = this.drag.start_drag.start_x, d = this.drag.start_drag.start_y;
          ...
          if (this._handlers[s.mode]) {
            if (s.mode === l.drag_mode.move) {
              ...
              if (a.isSummaryTask(h) && a.config.drag_project) {
                var y = {};
                y[s.id] = X(s), f = !0, _ = R(y, this.dragMultiple);
              }
              var v = this._find_max_shift(_, c);
              let m;
              if (v !== void 0 && (c = v), this._update_item_on_move(c, s.id, s.mode, s, o), v === void 0) {
                const p = a.posFromDate(s.obj.start_date), k = a.posFromDate(s.obj.end_date);
                if (s.handle_offset === void 0) {
                  const x = k - p, $ = s.start_x - p;
                  s.handle_offset = $ / x;
                }
                let w = p + Math.abs(k - p) * s.handle_offset;
                m = u - a.dateFromPos(w);
              }
              for (var b in _) {
                var g = _[b];
        ...
        if (l["drag_" + s.mode] && a.callEvent("onBeforeDrag", [d, s.mode, o]) && this._fireEvent("before_start", s.mode, [d, s.mode, o])) {
          ...
          if (this._isMultiselect()) {
            ...
            c.indexOf(s.id) >= 0 && ht(c, a.bind(function(h) {
              var _ = a.getTask(h);
...
var Ar = function(t, n) {
  ...
  function f(m, p) {
    var k, w = _.getPosition(m), x = function(M) {
      var I = 0, A = 0;
  ...
  function b(m, p, k, w) {
    ...
    if (T = Math.max(0, T - 3)) {
      ...
      if (window.navigator.userAgent.indexOf("MSIE 8.0") != -1) {
        ...
        var P = Math.abs(Math.round(m - k)), N = Math.abs(Math.round(w - p));
        switch (g(m, k, p, w)) {
          case 1:
            I -= N;
            break;
...
var Ir = function(t) {
  ...
  return { onCreated: function(e) {
    ...
    this._mouseDelegates.delegate("click", "gantt_task_link", e.bind(function(a, r) {
      ...
      var o = dt(a, e.$task_data), s = e.dateFromPos(o.x), l = Math.floor(e.columnIndexByDate(s)), d = e.getScale().trace_x[l];
...
const Nr = { init: function(t) {
  ...
  return t.ext.inlineEditors = a, t.ext._inlineEditors = a, a.init(t), { factory: e, mouseEvents: Ua.init(t), layersApi: i.init(), render: { gridLine: function() {
    return /* @__PURE__ */ function(r) {
      return { render: function(o, s, l, d) {
        for (var u = s.getGridColumns(), c = s.$getTemplates(), h = s.$config.rowStore, _ = [], f = 0; f < u.length; f++) {
          var y, v, b, g = f == u.length - 1, m = u[f];
          ...
          if (m.tree) {
            p += " gantt_cell_tree";
            for (var w = 0; w < o.$level; w++) k.push(c.grid_indent(o));
            !h.hasChild(o.id) || r.isSplitTask(o) && !r.config.open_split_tasks ? (k.push(c.grid_blank(o)), k.push(c.grid_file(o))) : (k.push(c.grid_open(o)), k.push(c.grid_folder(o)));
          }
    ...
    return /* @__PURE__ */ function(r) {
      ...
      function h(_, f, y, v, b, g, m, p) {
        ...
        if (Vt(f, _, v, r)) {
          ...
          if (o[y.id][f]) return s[y.id][f] = f, o[y.id][f];
          var T = document.createElement("div");
          return T.style.width = k + "px", w = "gantt_task_cell" + (f == b - 1 ? " gantt_last_cell" : ""), x && (w += " " + x), T.className = w, $ && (T.innerHTML = $), T.style.position = "absolute", T.style.left = _.left[f] + "px", o[y.id][f] = T, s[y.id][f] = f, T;
        }
        return null;
      }
      return { render: function(_, f, y, v) {
        ...
        var p, k = document.createElement("div"), w = u(f), x = c(f);
        ...
        var g = y.getScale(), m = g.count, p = u(y), k = c(y);
    ...
    return function(r) {
      const o = be(r), s = {};
      function l(c, h, _, f, y) {
        let v = !0;
        return f.smart_rendering && (v = It(c, h, _)), v;
      }
      function d(c, h, _, f) {
        const y = r.copy(r.getTask(h.id));
        if (y.$rendered_at = c.id, r.callEvent("onBeforeRollupTaskDisplay", [y.id, y, c.id]) === !1) return;
        const v = o(y, _);
        if (!v) return;
      ...
      return { render: function(c, h, _, f) {
        if (c.rollup !== !1 && c.$rollup && c.$rollup.length) {
          const y = document.createElement("div"), v = r.getTaskPosition(c);
          return f && (f.y = 0, f.y_end = r.$task_bg.scrollHeight), c.$rollup.forEach(function(b) {
            if (!r.isTaskExists(b)) return;
            const g = r.getTask(b);
            if (!l(g, f, h, _)) return;
            const m = d(c, g, h, v);
            m ? (s[u(g.id, c.id)] = m, y.appendChild(m)) : s[u(g.id, c.id)] = !1;
          }), y;
        }
        return !1;
      }, update: function(c, h, _, f, y) {
        const v = document.createElement("div"), b = r.getTaskPosition(c);
        y.y = 0, y.y_end = r.$task_bg.scrollHeight, c.$rollup.forEach(function(g) {
    ...
    return function(r) {
      ...
      function d(h, _, f, y, v) {
        ...
        p && (k = hn(x)), v && ($ = p ? Math.floor((k - x) / 2) + 2 : 2);
      ...
      return { render: function(h, _, f, y) {
        ...
        if (c(h, y)) {
          ...
          r.eachTask(function(p) {
            ...
            s[k] && b.appendChild(s[k]), _.innerHTML = "", _.appendChild(b);
          }, h.id);
        }
    ...
    return /* @__PURE__ */ function(r) {
      function o(s, l, d, u, c) {
        ...
        f && (_ = l.start_date);
        const y = r.getTaskPosition(s, l.start_date, _);
        let v, b = 0;
        if (f) {
          let T = u.getBarHeight(s.id, !0);
          v = hn(T), b = Math.floor((v - T) / 4);
        }
        let g = ne(r, u, s, y.rowHeight).maxHeight, m = y.top + 1 + b, p = u.getBarHeight(s.id, s.type);
        ...
        switch (r.config.baselines.render_mode) {
          ...
          case "individualRow":
            ...
            break;
          default:
            $ = 1, c ? (g = ne(r, u, s).maxHeight, b ? g >= v ? $ = (g - p) / 2 - 1 - b : (p = _n(g), m = y.top, $ = Math.abs(p - g) / 2, b = 0) : (g > p && ($ = (g - p) / 2 - 1), $ -= b), s.bar_height || ($ -= 1)) : (s.bar_height && y.rowHeight >= s.bar_height && ($ = (y.rowHeight - s.bar_height) / 2 - 1), $ += b, s.bar_height || ($ += 2), f && ($ += 1));
        }
        let S = y.top + g + 1 - b;
    ...
    return function(r) {
      ...
      function l(u, c, h, _, f) {
        var y = h.resource_cell_class(c.start_date, c.end_date, u, c.tasks, c.assignments), v = h.resource_cell_value(c.start_date, c.end_date, u, c.tasks, c.assignments), b = f.getItemHeight(u.id) - 1;
        if (y || v) {
          var g = f.getItemPosition(u, c.start_date, c.end_date), m = document.createElement("div");
          return m.setAttribute(f.$config.item_attribute, u.id), m.className = ["gantt_resource_marker", y].join(" "), m.style.cssText = ["left:" + g.left + "px", "width:" + g.width + "px", "height:" + b + "px", "line-height:" + b + "px", "top:" + g.top + "px"].join(";"), v && (m.innerHTML = v), m;
        }
        return null;
      }
      function d(u, c) {
      ...
      return { render: function(u, c, h, _) {
        var f = c.$getTemplates(), y = c.getScale(), v = o(u, h.resource_property, c.getScale(), c), b = !!_, g = [];
        s[u.id] = {};
        ...
        var y = h.$getTemplates(), v = h.getScale(), b = o(u, _.resource_property, h.getScale(), h), g = Ct(v, f), m = {};
        if (s && s[u.id]) for (var p in s[u.id]) m[p] = p;
        for (var k = g.start; k <= g.end; k++) {
          var w = b[k];
          if (m[k] = !1, w) if (Vt(k, v, f, r)) if (s[u.id] && s[u.id][k]) s[u.id] && s[u.id][k] && !s[u.id][k].parentNode && c.appendChild(s[u.id][k]);
          else {
            var x = l(u, w, y, 0, h);
            x && (c.appendChild(x), s[u.id][k] = x);
          }
          else d(u.id, k);
        }
...
function Br(t) {
  ...
  t._touch_events = function(r, o, s) {
    var l, d = 0, u = !1, c = !1, h = null, _ = null, f = null, y = [], v = null;
    let b = {};
    ...
    for (a.push([this.$container, "contextmenu", function(p) {
      ...
      if (document && document.body && document.body.classList.remove("gantt_touch_active"), !s(p)) {
        ...
        }), t._touch_feedback())), u = c = !1, y = [], f = null, h && d) {
  ...
  function i(a, r) {
    ...
    r && (o = t.getTaskByTime(), a.allow_root && o.unshift({ id: t.config.root_id, text: a.root_label || "" }), o = function(c, h, _) {
      ...
      for (var y = 0; y < c.length; y++) {
        var v = c[y];
        (v.id == _ || t.isChildOf(v.id, _) || f(v.id, v) === !1) && (c.splice(y, 1), y--);
      }
      return c;
  ...
  return t.attachEvent("onAfterLightbox", function() {
    ...
    (function(y, v) {
      ...
      var m = function(S) {
        ...
        var A = v[b.map_to];
        g.form_blocks.resources.set_value(y, A, v, T);
      };
      function p(S) {
        var T, E = S.target;
        if (S.target.type === "checkbox") {
          ...
          if (D.setAttribute("data-checked", E.checked), E.checked) {
            ...
            }), M && !M.value && A !== void 0 && (M.value = A, k(b, this)), M.select ? M.select() : M.focus && M.focus();
      ...
      var w, x, $;
    }(l, u, c, this), ht(c.options, function(y, v) {
      c.unassigned_value != y.key && (h = function(b, g, m) {
        var p = {};
        if (g) {
          var k;
    ...
    for (var c = o(u), h = [], _ = r(!0), f = r(!1), y = s(u), v = t.copy(e.resourcesValues[u.id]) || {}, b = c.querySelectorAll(_), g = c.querySelectorAll(f), m = 0; m < g.length; m++) delete v[g[m].getAttribute("data-item-id")];
...
function Fr(t) {
  var n = function() {
    ...
    return W(p, m), p.prototype.render = function($) {
      ...
      function F(V) {
        var j = P.value;
        j = k(E).parse(j), window.isNaN(j) && (j = 0), (j += V) < 1 && (j = 1), P.value = k(E).format(j), H();
      }
      ...
      }, this), P.onchange = g.bind(H, this), typeof (C = g._resolve_default_mapping(E)) == "string" && (C = { start_date: C }), D = T[C.start_date] || /* @__PURE__ */ new Date(), M = T[C.end_date] || g.calculateEndDate({ start_date: D, duration: 1, task: T }), I = Math.round(T[C.duration]) || g.calculateDuration({ start_date: D, end_date: M, task: T }), I = k(E).format(I), g.form_blocks._fill_lightbox_select(A, 0, D, O, E), P.value = I, H();
  ...
  if (!bt.isNode) {
    ...
    t.$ui = e.factory, t.$ui.layers = e.render, t.$mouseEvents = e.mouseEvents, t.$services.setService("mouseEvents", function() {
      ...
      return { getColumnIndex: function(c) {
        ...
        var _ = o(this), f = s(this), y = { position: 0 }, v = { position: 0 };
        ...
        }).bind(this)), f.scroll(c), k && k.forEach((function(T) {
        ...
        f = v ? h.top - (v - this.getTaskBarHeight(c)) / 2 : h.top, this.scrollTo(y, f);
      ...
      for (var d in i._waiAria = { getAttributeString: function(u) {
        ...
        var h = i.config.links, _ = u.type == h.finish_to_start || u.type == h.start_to_start, f = u.type == h.start_to_start || u.type == h.start_to_finish, y = i.locale.labels.link + " " + i.templates.drag_link(u.source, f, u.target, _);
        c.setAttribute("role", "img"), c.setAttribute("aria-label", o(y));
...
Y.gantt = Ur, Y.Gantt = Be, Be.plugin((t) => {
  Ye() || setTimeout(() => {
    ...
    if (!(typeof 1752561904000 > "u")) {
      var e, i;
      setInterval(() => {
        !t.$destroyed && Date.now() - 1752561904000 > 27648e5 && t.message({ type: "error", text: n, expire: -1, id: "evaluation-warning" });
